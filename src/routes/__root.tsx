...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ZeroLabNetwork" },
      { name: "description", content: "ZeroLabNetwork is an amazing project working in webapps / saas / tma etc..." },
      { property: "og:title", content: "ZeroLabNetwork" },
      { name: "twitter:title", content: "ZeroLabNetwork" },
      { property: "og:description", content: "ZeroLabNetwork is an amazing project working in webapps / saas / tma etc..." },
      { name: "twitter:description", content: "ZeroLabNetwork is an amazing project working in webapps / saas / tma etc..." },
